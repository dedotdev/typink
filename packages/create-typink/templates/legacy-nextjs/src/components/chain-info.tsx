...
export function ChainInfo({ className = '' }: Props) {
  ...
  return (
    <Card className={`bg-gray-200/70 dark:bg-gray-900/50 border-none shadow-none ${className}`}>
      ...
      <CardContent>
        <div className='bg-white/40 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden'>
          <div className='flex justify-center items-center gap-3 p-3 bg-white dark:bg-gray-800'>
